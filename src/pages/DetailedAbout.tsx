          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border border-medical-100 mb-12">
              ...
              <div className="space-y-4 text-medical-700">
                <p>
                  Dr. Osama Abuzaid brings over two decades of expertise in General
                  and Laparoscopic Surgery. His journey spans multiple prestigious
                  institutions across Jordan, the UK, and the UAE, where he has
                  consistently demonstrated excellence in surgical care and medical
                  education.
                </p>
                <p>
